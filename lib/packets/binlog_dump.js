...
const CharsetToEncoding = require('../constants/charset_encodings');
...
class BinlogDump {
  constructor(opts) {
    ...
    this.encoding = CharsetToEncoding[opts.charsetNumber] || 'binary';
  }
  ...
  toPacket() {
    ...
    packet.writeString(this.filename, this.encoding);
    return packet;
  }
}
